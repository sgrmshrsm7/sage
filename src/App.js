...
function App() {
    return (
        <div className="page">
            ...
            <div className="quote">
                Dreams are not what you see in your sleep, dreams are the things
            ...
            <div className="projects">
                ...
                <div className="cards">
                    <div className="card">
                        <div className="cardhead">VChat</div>
                        <div className="carddesc">
                            A group chat Java WebApp using JSP, Java Servlets,
                            AJAX, JQuery and MySQL.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">Big Int</div>
                        <div className="carddesc">
                            Basic operations like addition, subtraction and
                            multiplication on 1024bit numbers.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">Heap Management</div>
                        <div className="carddesc">
                            Heap Management using best fit strategy for
                            allocation of memory.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">Set Implementation</div>
                        <div className="carddesc">
                            Set DS using hash table implementing union,
                            intersection, difference, etc.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">Vivago</div>
                        <div className="carddesc">
                            A hotel booking website using HTML, CSS, JS, PHP,
                            SQL.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">Graph</div>
                        <div className="carddesc">
                            Graph data structure: BFS, DFS, Topo. sort,
                            Dijkstra's SP, Prim's MST, etc.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">4 in a row</div>
                        <div className="carddesc">
                            Simple GUI 4 in a row game using Tkinter.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">jscalc</div>
                        <div className="carddesc">
                            Just a basic js calculator.
                        </div>
                    </div>
                    <div className="card">
                        <div className="cardhead">Tic-Tac-Toe</div>
                        <div className="carddesc">
                            Simple GUI Tic-Tac-Toe game using Tkinter.
                        </div>
                    </div>
                </div>
            </div>
